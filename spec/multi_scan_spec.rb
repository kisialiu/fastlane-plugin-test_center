...
describe Fastlane::Actions::MultiScanAction do
  ...
  describe ':batch_count', lyndsey: true do
    ...
    it 'given an even number of tests, runs try_scan_with_retry with batches of tests', lyndsey: true do
      non_existent_project = "lane :test do
        multi_scan(
          project: File.absolute_path('../AtomicBoy/AtomicBoy.xcodeproj'),
          scheme: 'AtomicBoy',
    ...
    it 'given an odd number of tests, runs try_scan_with_retry with batches of tests', lyndsey: true do
      non_existent_project = "lane :test do
        multi_scan(
          project: File.absolute_path('../AtomicBoy/AtomicBoy.xcodeproj'),
          scheme: 'AtomicBoy',
